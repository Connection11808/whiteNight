    ...
    public void gyroDrive(double speed,
        ...
        if (direction == gyroDriveDirection.FORWARDandBACKWARD) {
            ...
            if (opModeIsActive()) {
                ...
                while (opModeIsActive() && !MotorInPosition(robot.right_front_motor) && !MotorInPosition(robot.left_back_motor)){
            ...
            while (opModeIsActive() && robot.left_back_motor.getCurrentPosition() < robot.left_back_motor.getTargetPosition()
                    && robot.right_front_motor.getCurrentPosition() < robot.right_front_motor.getTargetPosition()) {
